    ...
    <div>
        <div style="margin-left: 50px;">
            <div>
                ...
                <asp:TextBox ID="tbCourriel" runat="server" placeholder="courriel@courriel.com" MaxLength="150" />
            </div>
            <asp:LinkButton ID="lbtnEnvoyer" runat="server" CssClass="btn btn-primary" OnClick="lbtnEnvoyer_Click"><i class="icon-chevron-right icon-white"></i> Obtenir un nouveau mot de passe</asp:LinkButton>
        </div>
    </div>
</asp:Content>
